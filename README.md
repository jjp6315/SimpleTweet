...
<img src='https://i.imgur.com/W6OYmPy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- I had a little trouble implementing the word counter and could not figure out how to organize the layout of the page when I eventually did implement the word count.
...
- [x] List anything else that you can get done to improve the app functionality!
	- Implement a retweeting system where the user can retweet a tweet within my app. 
## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/WZqzdgO.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Describe any challenges encountered while building the app.
- I had a hard time trying to show the relative time stamp for each tweet.
